      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 sm:p-12">
        <div className="w-full max-w-md">
          <div className="lg:hidden mb-10 text-center">
            <h1 className="text-3xl font-black text-yellow-400">{AUTH_TEXTS.REGISTER_BRANDING_TITLE}</h1>
          </div>

          <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-8 shadow-2xl">
            <h2 className="text-3xl font-bold mb-2">{AUTH_TEXTS.LOGIN_TITLE}</h2>
            <p className="text-gray-400 mb-8">{AUTH_TEXTS.LOGIN_SUBTITLE}</p>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              <div>
                <label className="block text-sm font-medium text-gray-300 mb-2">{AUTH_TEXTS.LOGIN_EMAIL_LABEL}</label>
              ...
              <div>
                <label className="block text-sm font-medium text-gray-300 mb-2">{AUTH_TEXTS.LOGIN_PASSWORD_LABEL}</label>
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-gray-500">
                    <Lock size={18} />
                  </div>
